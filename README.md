...
1. Explain what a token is used for.
   A token is used for ensuring that each request to a server is secure and authenticated which the server verifies for authenticity and then responds to the request.

2. What steps can you take in your web apps to keep your data secure?
   Create private routes, authenticate each request with to the server with a token, use an SSL.

3. Describe how web servers work.
   Web servers are connected to the internet and store code for different websites to be shared across the world at all times. They use DNS to distinguish themselves from one another.
